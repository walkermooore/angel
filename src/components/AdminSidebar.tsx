...
const items: Array<{ to: "/admin" | "/admin/produtos" | "/admin/pedidos"; label: string; icon: typeof LayoutDashboard; exact?: boolean }> = [
  ...
  return (
    <aside className="w-60 shrink-0 border-r border-border/60 bg-secondary/30 min-h-screen sticky top-0 flex flex-col">
      ...
      <div className="p-3 border-t border-border/60">
        <button
          onClick={() => { adminAuth.logout(); navigate({ to: "/admin/login" }); }}
