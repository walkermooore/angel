...
export const institutionalDefaults: InstitutionalSettings = {
  termsContent: `Bem-vinda à loja online da Angell. Ao acessar e utilizar este site, você concorda com os seguintes termos e condições:
...
Garantimos a autenticidade do teor da Prata 925 de nossas peças. A garantia não cobre mau uso, quedas, arranhões ou exposição a reagentes químicos agressivos.`,
  exchangesContent: `Queremos que você fique 100% satisfeita com sua compra na Angell. Caso precise trocar ou devolver um produto, siga as orientações abaixo:
...
Envie uma mensagem via WhatsApp para nosso atendimento pelo número [contato removido] informando o número do seu pedido e o motivo da troca.`,
  privacyContent: `A Angell compromete-se com a segurança e a privacidade dos dados de nossos clientes durante todo o processo de navegação e compra pelo site.
