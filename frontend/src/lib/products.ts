...
export const products: Product[] = [
  { id: "1", name: "Colar Éclat Prata 925", price: 189, discountPercent: 10, discountPrice: 170.1, category: "prata", image: p1, description: "Colar minimalista em prata 925 com pingente delicado." },
  ...
  { id: "3", name: "Anel Solitaire Cristal", price: 229, discountPercent: 15, discountPrice: 194.65, category: "prata", image: p3, description: "Anel em prata com cristal transparente lapidado." },
